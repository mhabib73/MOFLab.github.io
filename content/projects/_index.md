...
sections:
  ...
  - block: hero
    content:
      ...
      text: text: '<span style="color:#e0e0e0;">MOFLab Projects</span> - Exploring state-of-the-art optical fiber design and fabrication, ultrafast photonics, and nonlinear fiber dynamics.'
    design:
      background:
        color: "#71548C"
